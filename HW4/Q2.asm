...
msg3  db 0Dh,0Ah, 'enter 0 For ADD $' 
msg4  db 0Dh,0Ah, 'enter 1 For SUB $'
msg5  db 0Dh,0Ah, 'enter 2 For MUL $'
msg6  db 0Dh,0Ah, 'enter 3 For DIV $'
msg7 db 0Dh,0Ah, 'enter 4 For EXIT $'
msg8  db 0Dh,0Ah, 'enter command: $'
resmsg  db 0Dh,0Ah, 'Result: $'  
divrmsg  db 0Dh,0Ah, 'remainder: $'
divqmsg   db 0Dh,0Ah, 'quotient: $'
